...
<script>
    ...
    let tabelSuratSifatDt = null;

    // untuk datatable
    var untukTabelSuratJenis = function() {
        tabelSuratSifatDt = $('#tabel-sifat-surat').DataTable({
            responsive: true,
            processing: true,
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <div class="button-icon-btn button-icon-btn-cl">
                            <button type="button" id="btn-upd" data-id="` + full.id_surat_sifat + `" class="btn btn-info btn-sm waves-effect" data-toggle="modal" data-target="#modal-add-upd"><i class="fa fa-pencil"></i>&nbsp;Ubah</button>&nbsp;
                            <button type="button" id="btn-del" data-id="` + full.id_surat_sifat + `" class="btn btn-warning btn-sm waves-effect"><i class="fa fa-trash"></i>&nbsp;Hapus</button>
                        </div>
                    `;
                    },
                },
        ...
        $(document).on('click', '#btn-del', function() {
            ...
            swal({
                ...
                if (del) {
                    $.ajax({
                        type: "post",
                        url: "<?= admin_url() ?>sifat_surat/process_del",
                        dataType: 'json',
                        data: {
                            id: ini.data('id'),
                            my_csrf_token: csrf.val(),
