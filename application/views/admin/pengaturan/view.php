                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-logo" action="<?= admin_url() ?>pengaturan/upd_foto/<?= (empty($data->id_pengaturan) ? null : $data->id_pengaturan) ?>" method="POST">
                                            <input type="hidden" id="<?= $this->security->get_csrf_token_name() ?>_logo" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-profil" action="<?= admin_url() ?>pengaturan/upd_profil/<?= (empty($data->id_pengaturan) ? null : $data->id_pengaturan) ?>" method="POST">
                                            <input type="hidden" id="<?= $this->security->get_csrf_token_name() ?>_profil" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="inpfax" id="inpfax" value="<?= (empty($data->fax) ? null : $data->fax) ?>" placeholder="Masukkan fax" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Situs Web *</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="inpsitusweb" id="inpsitusweb" value="<?= (empty($data->situs_web) ? null : $data->situs_web) ?>" placeholder="Masukkan situs web" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
