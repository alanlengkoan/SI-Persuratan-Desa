            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped table-bordered nowrap" id="tabel-organisasi">
                        </table>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-add-upd" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form-add-upd" action="<?= admin_url() ?>organisasi/process_save" method="POST">
                <!-- begin:: id -->
                <input type="hidden" name="inpidorganisasi" id="inpidorganisasi" />
                <!-- end:: id -->
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inporganisasi" id="inporganisasi" placeholder="Masukkan nama" />
                        </div>
                    </div>
                    <div class="form-group row">
