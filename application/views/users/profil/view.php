                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="foto" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-foto" action="<?= users_url() ?>profil/upd_foto" method="POST">
                            ...
                            <div class="tab-pane" id="akun" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-akun" action="<?= users_url() ?>profil/upd_akun" method="POST">
                                            <input type="hidden" id="<?= $this->security->get_csrf_token_name() ?>_akun" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
                            ...
                            <div class="tab-pane" id="keamanan" role="tabpanel">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form id="form-keamanan" action="<?= users_url() ?>profil/upd_keamanan" method="POST">
                                            <input type="hidden" id="<?= $this->security->get_csrf_token_name() ?>_keamanan" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
