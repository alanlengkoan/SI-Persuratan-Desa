...
class M_surat_keluar extends CI_Model
{
    ...
    {
        $this->datatables->select('sk.id_surat_keluar, sk.no_surat, sk.tgl_surat, sk.tgl_keluar, sk.perihal, sk.approve, sk.isi, sj.nama AS jenis_surat, st.nama AS tujuan_surat, ss.nama AS sifat_surat');
    ...
    {
        $this->datatables->select('sk.id_surat_keluar, sk.id_users, sk.no_surat, sk.tgl_surat, sk.tgl_keluar, sk.perihal, sk.approve, sk.isi, sj.nama AS jenis_surat, st.nama AS tujuan_surat, ss.nama AS sifat_surat');
        $this->datatables->join('tb_surat_jenis AS sj', 'sk.id_surat_jenis = sj.id_surat_jenis', 'left');
        $this->datatables->join('tb_surat_tujuan AS st', 'sk.id_surat_tujuan = st.id_surat_tujuan', 'left');
        $this->datatables->join('tb_surat_sifat AS ss', 'sk.id_surat_sifat = ss.id_surat_sifat', 'left');
