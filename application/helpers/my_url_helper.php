...
// untuk owner url
if ( ! function_exists('owner_url'))
{
    function owner_url($url = NULL)
    {
        $link = ($url)? '/'.$url : '';
        return site_url('owner/').$link;
    }
}

// untuk fotografer url
if ( ! function_exists('fotografer_url'))
{
    function fotografer_url($url = NULL)
    {
        $link = ($url)? '/'.$url : '';
        return site_url('fotografer/').$link;
    }
}
